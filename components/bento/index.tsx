...
import BarChart from "@/common/animata/graphs/bar-chart";
import AvatarList from "@/common/animata/list/avatar-list";
import Report from "@/common/animata/skeleton/report";
import WideCard from "@/common/animata/skeleton/wide-card";
import Counter from "@/common/animata/text/counter";
import Ticker from "@/common/animata/text/ticker";
import TypingText from "@/common/animata/text/typing-text";
